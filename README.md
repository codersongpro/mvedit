...
Phase 9까지 완료. 파일 불러오기, 타임라인 편집(자르기·트림·지우기·순서·되돌리기),
빈 화면·이미지 클립, 볼륨·음소거, 미리보기 재생, 자막 입력·굽기·`.srt` 내보내기,
화면비·해상도·화질 설정까지 동작합니다.

남은 것: 목표 용량 인코딩(10), 자동 저장·프로젝트 목록(11), `.cutcap` 파일(12),
모바일 세로 레이아웃(13), ffmpeg.wasm 폴백·PWA(14), 성능 검증(15).
